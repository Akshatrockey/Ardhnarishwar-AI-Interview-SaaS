...
export const LiveZoomMeetingView: React.FC<LiveZoomMeetingViewProps> = ({
  ...
  // Local media streams for embedded meet interface
  ...
  useEffect(() => {
    ...
    const fetchCredentials = async () => {
      ...
      try {
        ...
        if (isMounted) {
          // If 403 Forbidden, display exact error
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between font-sans">
      ...
      {/* Main Video Arena */}
      <main className="flex-1 p-4 sm:p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
        ...
        <div className="space-y-5">
          <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-5">
            ...
            <div className="space-y-3 pt-2">
              <a
                href={credentials?.web_client_url}
                target="_blank"
                rel="noreferrer"
              ...
              >
                <span>Launch Zoom Web Client</span>
